...
Creating the annotation for a field is nothing diff than the others we just did
...
And on our Dog Class we just annotate the field name
...
Checking if a field has annotation and doing something in main:
